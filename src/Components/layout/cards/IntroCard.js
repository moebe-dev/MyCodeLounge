              ...
              <CardContent>
                ...
                >
                  <Box textAlign="center" fontSize={16} className={classes.Box}>
                    Hypertext Markup Languange, HTML is used to create different
                    pages on the internet is is the foundation for a lot of the
                    code you will be learning!
                  </Box>
                </Typography>
              </CardContent>
            </CardActionArea>
          ...
          <Card className={classes.Card}>
            <CardActionArea>
              ...
              <CardContent>
                ...
                >
                  <Box textAlign="center" fontSize={16} className={classes.Box}>
                    Cascading Style Sheets, desribes how the HTML elements will
                    be positioned and styled on the page. This language is what
                    adds color and life to your application! Colored borders? No
                    Problem! Use Css!
                  </Box>
                </Typography>
              </CardContent>
              ...
              <CardContent>
                ...
                >
                  <Box textAlign="center" fontSize={16} className={classes.Box}>
                    ...
                    pages interactive. JavaScript gives web pages interactive
              ...
              <CardContent>
                ...
                >
                  <Box textAlign="center" fontSize={16} className={classes.Box}>
                    ...
                    library. The purpose of jQuery is to make it much easier to
